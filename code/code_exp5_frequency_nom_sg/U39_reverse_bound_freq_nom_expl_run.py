...
from U39_reverse_bound_freq_nom_expl import *
...
markerNum = sentence2text(dict_words['sg'])
markerCase = sentence2text(dict_words['agent'])
...
explicit_instructions(myWin,path,dict_sentences, dict_meanings_all[1])
